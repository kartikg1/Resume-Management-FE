...
export class EmpInfoComponent implements OnDestroy, OnInit {
  ...
  ngOnInit() {
    ...
    console.log("hello2");
   // this.GetEmployeeProjects(this.viewId);
  ...
  loadEmpDetails(Id: number) {
    this.details.getEmployeeById(Id).subscribe(res => {
      this.employee = res;
     // this.empProjects = this.details.data;
    })
  }
  ...
  //   this.details.getEmployeeProjects(id).subscribe(data=>{
  //     this.e=data;
  //     this.employee=this.e;
  //     console.log(this.e);
  //     console.log("employee with projects");
